...
#
# Axku5DaqBuild.tcl: Tcl script for re-creating project 'Axku5Daq'
#
# Generated by Vivado on Fri Mar 28 07:51:39 CST 2025
...
#
# 1. This project restoration tcl script (Axku5DaqBuild.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/ltr/IdeaProjects/SpinalHDL/Axku5Daq/AdiSpiCtrl.v"
#    "/home/ltr/IdeaProjects/SpinalHDL/chainsaw/src/main/resources/LZOC.vhdl"
#    "/home/ltr/IdeaProjects/SpinalHDL/Axku5Daq/ChainsawDaqDataPath.v"
#    "/home/ltr/IdeaProjects/SpinalHDL/Axku5Daq/Axku5Daq.v"
#    "/home/ltr/IdeaProjects/SpinalHDL/chainsaw/src/main/resources/AlinxConstraintSources/Axku5/Axku5Basic.xdc"
#    "/home/ltr/IdeaProjects/SpinalHDL/chainsaw/src/main/resources/AlinxConstraintSources/Axku5/Axku5Ddr4.xdc"
#    "/home/ltr/IdeaProjects/SpinalHDL/chainsaw/src/main/resources/AlinxConstraintSources/Axku5/Axku5Fmc.xdc"
#    "/home/ltr/IdeaProjects/SpinalHDL/chainsaw/src/main/resources/AlinxConstraintSources/Axku5/Axku5Pcie.xdc"
#    "/home/ltr/IdeaProjects/SpinalHDL/chainsaw/src/main/resources/AlinxConstraintSources/MysoowFmc.xdc"
#    "/home/ltr/IdeaProjects/SpinalHDL/chainsaw/src/main/resources/ProjectConstraints/Axku5Daq/Axku5Daq.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../chainsaw/src/main/resources/ProjectConstraints/Axku5Daq/Axku5Daq.xdc"]"\
  ]
  foreach ifile $files {
...
set script_file "Axku5DaqBuild.tcl"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../chainsaw/src/main/resources/ProjectConstraints/Axku5Daq/Axku5Daq.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../chainsaw/src/main/resources/ProjectConstraints/Axku5Daq/Axku5Daq.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../chainsaw/src/main/resources/ProjectConstraints/Axku5Daq/Axku5Daq.xdc"]" -objects $obj
set_property -name "target_part" -value "xcku5p-ffvb676-2-i" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../chainsaw/src/main/resources/ProjectConstraints/Axku5Daq/Axku5Daq.xdc"]" -objects $obj
...
if { [get_files [list AdiSpiCtrl.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/ltr/IdeaProjects/SpinalHDL/Axku5Daq/AdiSpiCtrl.v
}
if { [get_files [list AdiSpiCtrl.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/ltr/IdeaProjects/SpinalHDL/Axku5Daq/AdiSpiCtrl.v
}
...
if { [get_files [list ChainsawDaqDataPath.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/ltr/IdeaProjects/SpinalHDL/Axku5Daq/ChainsawDaqDataPath.v
}
