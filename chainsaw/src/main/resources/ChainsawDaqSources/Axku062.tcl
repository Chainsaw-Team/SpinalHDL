...
#
# Generated by Vivado on Fri Jun 21 14:12:37 +0800 2024
...
# AdiSpiCtrl, Hmc7044Ctrl
  ...
  # Create instance: ad9695_iobuf, and set properties
  set ad9695_iobuf [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.1 ad9695_iobuf ]
  set_property -dict [ list \
  ...
  # Create instance: hmc7044_iobuf, and set properties
  set hmc7044_iobuf [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.1 hmc7044_iobuf ]
  set_property -dict [ list \
   CONFIG.C_BUF_TYPE {IOBUF} \
 ] $hmc7044_iobuf
...
connect_bd_intf_net -intf_net [get_bd_intf_nets jesd204_0_m_axis_rx] [get_bd_intf_ports jesd204_rx_data] [get_bd_intf_pins jesd204_ila/SLOT_0_AXIS]
  ...
  connect_bd_net -net AdiSpiCtrl_0_sdReadEnable [get_bd_pins AdiSpiCtrl_0/sdReadEnable] [get_bd_pins ad9695_iobuf/IOBUF_IO_T]
  connect_bd_net -net AdiSpiCtrl_0_sdo [get_bd_pins AdiSpiCtrl_0/sdo] [get_bd_pins ad9695_iobuf/IOBUF_IO_I]
  connect_bd_net -net Hmc7044Ctrl_0_sclk [get_bd_ports hmc7044_sclk] [get_bd_pins Hmc7044Ctrl_0/sclk]
  connect_bd_net -net Hmc7044Ctrl_0_sdWriteEnable [get_bd_pins Hmc7044Ctrl_0/sdReadEnable] [get_bd_pins hmc7044_iobuf/IOBUF_IO_T]
  connect_bd_net -net Hmc7044Ctrl_0_sdo [get_bd_pins Hmc7044Ctrl_0/sdo] [get_bd_pins hmc7044_iobuf/IOBUF_IO_I]
  connect_bd_net -net Hmc7044Ctrl_0_slen [get_bd_ports hmc7044_slen] [get_bd_pins Hmc7044Ctrl_0/slen]
  connect_bd_net -net Net [get_bd_ports hmc7044_sdata] [get_bd_pins hmc7044_iobuf/IOBUF_IO_IO]
  connect_bd_net -net Net1 [get_bd_ports ad9695_sdio] [get_bd_pins ad9695_iobuf/IOBUF_IO_IO]
  ...
  connect_bd_net -net jesd204_0_rx_aresetn [get_bd_pins jesd204_0/rx_aresetn] [get_bd_pins jesd204_ila/resetn]
  ...
  connect_bd_net -net util_ds_buf_0_IOBUF_IO_O [get_bd_pins Hmc7044Ctrl_0/sdi] [get_bd_pins hmc7044_iobuf/IOBUF_IO_O]
  connect_bd_net -net util_ds_buf_1_IOBUF_IO_O [get_bd_pins AdiSpiCtrl_0/sdi] [get_bd_pins ad9695_iobuf/IOBUF_IO_O]
  ...
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_ports xdma_data_rstn] [get_bd_pins AdiSpiCtrl_0/resetn] [get_bd_pins Hmc7044Ctrl_0/resetn] [get_bd_pins control_router/aresetn] [get_bd_pins ddr_router/aresetn] [get_bd_pins ila_all_in_one/resetn] [get_bd_pins xdma/axi_aresetn]
