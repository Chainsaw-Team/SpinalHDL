...
#
# CreateChainsawDaqTemp.tcl: Tcl script for re-creating project 'ChainsawDaq'
#
# Generated by Vivado on Thu Jun 27 14:15:19 +0800 2024
...
#
# 1. This project restoration tcl script (CreateChainsawDaqTemp.tcl) that was generated.
#
...
set script_file "CreateChainsawDaqTemp.tcl"
...
proc cr_bd_Peripheral { parentCell } {
  ...
  # Create instance: ddr4_reset_250M, and set properties
  set ddr4_reset_250M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 ddr4_reset_250M ]
  ...
  connect_bd_intf_net -intf_net xdma_M_AXI [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins xdma/M_AXI]
  ...
  connect_bd_net -net ACLK_1 [get_bd_pins axi_smc/aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins xdma/axi_aclk]
  connect_bd_net -net aclk1_0_1 [get_bd_ports sys_clk_200M] [get_bd_pins ddr4_0/c0_sys_clk_i] [get_bd_pins smartconnect_0/aclk1]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins axi_smc/aclk1] [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins ddr4_reset_250M/slowest_sync_clk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins ddr4_reset_250M/ext_reset_in]
  ...
  connect_bd_net -net reset_rtl_0_2 [get_bd_ports ddr4_rst] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net rst_ddr4_0_250M_peripheral_aresetn [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins ddr4_reset_250M/peripheral_aresetn]
  ...
  connect_bd_net -net xdma_axi_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins xdma/axi_aresetn]
